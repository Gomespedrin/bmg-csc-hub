-- Script para limpar duplicatas por email
-- Execute este script no Supabase SQL Editor

-- 1. Verificar duplicatas por email
SELECT 
  'ANTES - Duplicatas por email' as status,
  email,
...
-- 2. Manter apenas o perfil mais recente por email
...
SELECT 
  'DEPOIS - Perfil único por email' as status,
  id,
  user_id,
  nome,
  email,
